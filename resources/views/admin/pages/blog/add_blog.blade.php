            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> اضافة مدونة <small>جديد</small> </h3>
                        <i class="pull-left header fa fa-th"></i>
                    </div><!-- /.box-header -->

                    <form role="form" id="signupForm1" action="{{ route('blog.store') }} " onsubmit="return check()"
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">العنوان بالعربية :</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="title_ar"
                                                                    value="{{ old('title_ar') }}" placeholder=""
                                                                    data-fv-field="">
                                                                @error('title_ar')
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">العنوان بالانجليزية :</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="title_en"
                                                                    value="{{ old('title_en') }}" placeholder=""
                                                                    data-fv-field="">
                                                                @error('title_en')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">الوصف بالعربي  :</label>
                                                            <div class="col-sm-9">

                                                                    <textarea name="discription_ar"  class="form-control"
                                                                    value="{{ old('discription_ar') }}" id="" cols="6"
                                                                    rows="6"></textarea>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">الوصف بالانجليزية :</label>
                                                            <div class="col-sm-9">
                                                                <textarea name="discription_en"  class="form-control"
                                                                    value="{{ old('discription_en') }}" id="" cols="6"
                                                                    rows="6"></textarea>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="signupForm1" action="{{route('blog.store')}}" onsubmit="return check()" method="post" class="form-horizontal" enctype="multipart/form-data">
                      @csrf
