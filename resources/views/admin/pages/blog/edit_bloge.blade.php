            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> تعديل المدونة  </h3>
                        <i class="pull-left header fa fa-th"></i>
                    </div><!-- /.box-header -->

                    <form role="form" id="signupForm1" action="{{ route('blog.update' , $blog->id) }}" onsubmit="return check()"
                                                ...
                                                <div class="col-md-8">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="title_ar"
                                                                    value="{{$blog->title_ar}}" placeholder=""
                                                                    data-fv-field="">
                                                                @error('title_ar')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="title_en"
                                                                    value="{{ $blog->title_en }}" placeholder=""
                                                                    data-fv-field="">
                                                                @error('title_en')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                    ...
                                                                    <textarea name="discription_ar" type="text" class="form-control"
                                                                    value="" id="" cols="9"
                                                                    rows="8">{{old('discription_ar' , $blog->discription_ar)}}</textarea>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea name="discription_en" type="text" class="form-control"
                                                                    value="" id="" cols="9"
                                                                    rows="8">{{old('discription_en' , $blog->discription_en)}}</textarea>
