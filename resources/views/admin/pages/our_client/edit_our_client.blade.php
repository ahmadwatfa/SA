        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="signupForm1" action="{{ route('clients.update' , $client->id) }}" onsubmit="return check()"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">صورة الشريك :</label>
                                                            <div class="col-sm-9">
                                                        <div class="file-upload">
                                                            ...
                                                            <div class="image-upload-wrap">
                                                                <input class="file-upload-input" type='file' name="image"
                                                                    ...
                                                                    @if($client->image)<img src="{{ asset('storage/' . $client->image) }}" width="100%">@endif
                                                                    @error('image')
