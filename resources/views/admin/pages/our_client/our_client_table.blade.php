                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <a href="{{ route('clients.create') }}" class="btn btn-primary pull-left">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($clients as $client)
                                        <tr>
                                            ...
                                            <td>{{ $i++ }}</td>
                                            <td><img src="{{ asset('storage/' . $client->image) }}" width="200" height="200"></td>
                                            <td width="20%" align="center">
                                                
                                                <a href="{{ route('clients.edit' , $client->id) }}" title="تعديل" type="button" class="btn btn-primary btn-xs">
...
<div class="modal-content modal-content-demo">
    ...
    <form action="/admin/clients/{client}" method="post">
        @csrf
        @method('delete')
