        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="signupForm1" action="{{route('review.store')}}" onsubmit="return check()" method="post" class="form-horizontal" enctype="multipart/form-data">
                      @csrf
                        ...
                        <div class="col-md-8">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="name_ar" placeholder="" data-fv-field="">
                              </div>
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" class="form-control" name="position_ar" placeholder="" data-fv-field="">
                                </div>
                              </div>
                        ...
                        <div class="col-md-8">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <label class="col-sm-3 control-label">اسم العميل  :</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="name_en" placeholder="" data-fv-field="">
                              </div>
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">المسمى الوظيفي  :</label>
                                <div class="col-sm-9">
                                  <input type="text" class="form-control" name="position_en" placeholder="" data-fv-field="">
                                </div>
                              </div>
