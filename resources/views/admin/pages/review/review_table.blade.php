    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">قائمة الآراء</li>
            </ol>
        </section>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title"> <i class="fa fa-laptop"></i> قائمة الآراء </h3>
                                    <a href="{{ route('review.create') }}" class="btn btn-primary pull-left"><i
                                            class="fa fa-plus"></i> إضافة رأي جديد </a>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="tbody-act">
                                            ...
                                            @foreach ($reviews as $review)
                                                ...
                                                <tr>
                                                    <td>{{ $i++ }}</td>
                                                    <td>{{ $review->name_ar }}</td>
                                                    <td>{{ $review->position_ar }}</td>
                                                    
                                                    <td>{!! \Illuminate\Support\Str::limit($review->description_ar ,  50 , '...') !!}</td>
                                                    <td><img src="{{ asset('storage/' . $review->image) }}" width="200" height="200"></td>
                                                    <td width="20%" align="center">
                                                        
                                                        <a href="{{ route('review.edit', $review->id) }}" title="تعديل"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف الرأي</h6><button aria-label="Close" class="close" data-dismiss="modal"
                                                                   type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="/admin/review/{review}" method="post">
                    @csrf
                    @method('delete')
