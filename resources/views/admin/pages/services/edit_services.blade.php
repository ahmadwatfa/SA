            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title"> اضافة خدمة <small>جديدة</small> </h3>
                      <i class="pull-left header fa fa-th"></i>
                    </div><!-- /.box-header -->
    
                    
                    <form role="form" id="signupForm1" action="{{route('services.update' , $services->id)}}" onsubmit="return check()" method="post" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                  ...
                  <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs pull-right">
                      <li class="active"><a href="#tab_1-1" data-toggle="tab" active>الخدمة بالعربية</a></li>
                      <li><a href="#tab_2-2" data-toggle="tab">الخدمة بالانجليزية </a></li>
                        ...
                        <div class="col-md-8">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control"  value="{{old('title_ar' , $services->title_ar)}}" name="title_ar" placeholder="" data-fv-field="">
                              </div>
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <input type="text"  class="form-control" value="{{old('description_ar' , $services->description_ar)}}" name="description_ar" placeholder="" data-fv-field="">
                              </div>
                            </div>
                          ...
                          <div class="col-md-9">
                            ...
                            <div class="file-upload">
                              ...
                              <div class="image-upload-wrap">
                                   @if($services->image)<img src="{{ asset('storage/' . $services->image) }}" width="300px">@endif
                                @error('image')
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">العنوان  :</label>
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" value="{{old('title_en' , $services->title_en)}}" name="title_en" placeholder="" data-fv-field="">
                                  </div>
                                </div>
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">التفاصيل  :</label>
                                  <div class="col-sm-9">
                                    <input type="text"  class="form-control" value="{{old('description_en' , $services->description_en)}}" name="description_en" placeholder="" data-fv-field="">
                                  </div>
                                </div>
